...
class Course extends Element {
	...
	createSummary(lastVisit) {
		...
		let html =
			'<div class="summary-section"><h3 class="content-title">' +
			'Summary' +
			'</h3><hr class="blue-hr"><h2 class="content-subtitle">Final grade: ';
		let subTitle = '';
		...
		html +=
			...
			Icons.dots_seperator() +
			'<div class="main-dot"></div><div class="main-dot"></div><div class="main-dot"></div></div></div>';
		return html;
	}
		...
		try {
			...
			for (let i = 0; i < this.modules.length; i++) {
				...
				if (i != this.modules.length - 1) {
					html +=
						'<div class="section-seperator"><div class="main-dot"></div><div class="main-dot"></div><div class="main-dot"></div></div>';
				}
			}

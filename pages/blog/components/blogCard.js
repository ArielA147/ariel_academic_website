...
class BlogCard extends Element {
	...
	toHtml() {
		...
		var answer =
			'<div class="academic-papers-panel"><h3 class="blog-title">' +
			this.title +
			'</h3><p>' +
			this.description +
			'</p><div class="personal-row space-between align-items-center mobile-row-breaker"><div class="w-100"><span class="blog-data">' +
			this.day +
			'/' +
			this.month +
			'/' +
			this.year +
			'</span></div><div class="w-100 flex-end align-items-center mobile-row-spacer"><a href="blog-post.html?post=' +
